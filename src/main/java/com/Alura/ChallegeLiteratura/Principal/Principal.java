package com.Alura.ChallegeLiteratura.Principal;

import com.Alura.ChallegeLiteratura.Model.*;
...
import com.Alura.ChallegeLiteratura.Service.ConsumoApi;
import com.Alura.ChallegeLiteratura.Service.ConversionDatos;
...
public class Principal {
    ...
    public Principal(AutorRepository repositorioAutores, LibroRepository repositorioLibros) {
    ...
    public void muestraMenu() {
        ...
        while (opcion != 0) {
            ...
            try {
                ...
                System.out.println("Opción inválida. Por favor, ingrese una opción del 1 al 5, o si desea finalizar la aplicación ingrese la opción 0.");
                muestraMenu();
            }
    ...
    private void buscarLibroApi() {
        DatoGeneral datosGenerales = obtenerDatosLibro();
        DatoLibro datosLibro = datosGenerales.resultados().get(0);
        Libro libro = new Libro(datosLibro);
        if (libro.getTitulo().toLowerCase().contains(nombreLibro)) {
            DatoAutor datosAutor = datosLibro.autor().get(0);
    ...
    private void registroAutoresVivos() {
        ...
        if (ano <= anoActual) {
            ...
            System.out.println("El año ingresado es posterior al año actual. Por favor, ingrese otro año.");
        }
    }
    ...
    private DatoGeneral obtenerDatosLibro() {
        System.out.println("Ingrese el título del libro que desea buscar.");
        nombreLibro = teclado.nextLine().toLowerCase();
        var json = consumoApi.obtenerDatos(URL_BASE + "?search=" + nombreLibro.replace(" ", "+"));
        if (json.contains("title")) {
            DatoGeneral datos = conversor.obtenerDatos(json, DatoGeneral.class);
            return datos;
        } else {
            System.out.println("Este libro no existe. Por favor, ingrese un libro existente.");
            DatoGeneral datos = obtenerDatosLibro();
            return datos;
        }
    }
}
